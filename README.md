...
```yaml
logo_img: /assets/img/icons/simplex_logo.svg #Absolute path to the logo. If not specified, the title will be displayed instead.
...
- title: Programming #Menu item title.
  ...
  icon: assets/img/icons/c.svg #Menu item icon.
...
- title: Design
  ...
  icon: assets/img/icons/paint_brush.svg
